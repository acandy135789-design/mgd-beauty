      ...
      return (
        React.createElement('section', { className: "sec-forest", style: { padding: '140px 0', position: 'relative', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 155}}
          , React.createElement('div', { style: { textAlign: 'center', marginBottom: 80 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 156}}
            , React.createElement('div', { className: "reveal", style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#1A0828' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 157}}, "HAIR HEALTH TECHNOLOGY"  )
            , React.createElement('span', { className: "gold-line", __self: this, __source: {fileName: _jsxFileName, lineNumber: 158}} )
            , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(2rem, 3.5vw, 3.2rem)', fontWeight: 400, color: '#1A0828', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 159}}, "開運科技健髮"
              , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 160}} )
              , React.createElement('em', { style: { color: '#1A0828', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 161}}, "從頭皮開始，好好照顧自己")
            )
          )
          , React.createElement('div', { className: "two-col-grid", style: { maxWidth: 1380, margin: '0 auto', padding: '0 48px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, alignItems: 'start' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 164}}
            , React.createElement('div', { className: "svc-card reveal delay-1"  , style: { background: 'rgba(13,26,14,0.8)', backdropFilter: 'blur(8px)' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 165}}
              ...
              , React.createElement('div', { style: { padding: '40px 44px 48px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 173}}
                , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.5em', color: '#3A1E52', marginBottom: 10 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 174}}, "EXOSOME HAIR TECHNOLOGY"  )
                , React.createElement('h3', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 28, fontWeight: 500, color: '#1A0828', letterSpacing: '0.05em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 175}}, "外泌體頭皮深度修護")
              ...
              , features.map((f, i) => (
                React.createElement('div', { key: f.title, className: `ing-circle reveal delay-${(i % 3) + 1}`, style: {
                  ...
                  , React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 197}}
                    , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 24, fontWeight: 500, color: '#1A0828', letterSpacing: '0.06em', marginBottom: 10 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 198}}, f.title)
                    , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#3A1E52', lineHeight: 2, letterSpacing: '0.06em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 199}}, f.desc)
                  )
                )
              ))
            )
        ...
        React.createElement('section', { style: { background: 'linear-gradient(150deg, #FFFBF9 0%, #F7D6C8 100%)', padding: '100px 0 140px', position: 'relative' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 223}}
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto', padding: '0 48px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 224}}
            ...
            , React.createElement('div', { style: { textAlign: 'center', marginBottom: 80 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 227}}
              , React.createElement('div', { className: "reveal", style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#1A0828' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 228}}, "BEFORE · AFTER"  )
              , React.createElement('span', { className: "gold-line", __self: this, __source: {fileName: _jsxFileName, lineNumber: 229}} )
              , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 400, color: '#1A0828', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 230}}, "客戶見證成果"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 231}} )
                , React.createElement('em', { style: { color: '#1A0828', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 232}}, "真實案例・有目共睹")
              )
              , React.createElement('div', { style: { marginTop: 40, display: 'flex', flexDirection: 'column', gap: 20, alignItems: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 234}}
                , React.createElement('p', { className: "reveal delay-2" , style: { fontFamily: '"Noto Serif TC", serif', fontSize: 22, fontWeight: 400, color: '#1A0828', letterSpacing: '0.1em', lineHeight: 1.8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 235}}, "你也想要這樣的改變嗎？"
                  , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 236}} )
                  , React.createElement('span', { style: { fontSize: 18, color: '#3A1E52' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 237}}, "如果這正是你在找的，我們聊聊")
                )
                , React.createElement('p', { className: "reveal delay-3" , style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: '#3A1E52', letterSpacing: '0.08em', lineHeight: 2, maxWidth: 560 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 239}}, "你會為社交及外貌焦慮困擾嗎？"
        ...
        React.createElement('section', { style: { background: '#F9F8FC', padding: '100px 0 140px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 312}}
          , React.createElement('div', { style: { maxWidth: 860, margin: '0 auto', padding: '0 48px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 313}}
            , React.createElement('div', { style: { textAlign: 'center', marginBottom: 80 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 314}}
              ...
              , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 400, color: '#1A0828', lineHeight: 1.4 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 317}}, "顧客健髮喜悅分享"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 318}} )
                , React.createElement('em', { style: { color: '#1A0828', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 319}}, "真實見證・用心陪伴")
              )
              , React.createElement('p', { className: "reveal delay-2" , style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, color: '#3A1E52', lineHeight: 2.2, marginTop: 28, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 321}}, "每一張照片背後，都是一段從擔心到放心的旅程。"
