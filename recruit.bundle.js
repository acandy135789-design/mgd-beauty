        ...
        React.createElement('section', { style: {
          ...
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 163}}
            , React.createElement('div', { style: { textAlign: 'center', marginBottom: 80 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 164}}
              , React.createElement('div', { className: "reveal", style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#C5A059' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 165}}, "JOIN US" )
              , React.createElement('span', { className: "gold-line", __self: this, __source: {fileName: _jsxFileName, lineNumber: 166}} )
              , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(2rem, 3.5vw, 3.2rem)', fontWeight: 400, color: '#F0ECE4', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 167}}, "夥伴招募"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 168}} )
                , React.createElement('em', { style: { color: '#C5A059', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 169}}, "與我們一起改變人生")
              )
              , React.createElement('p', { className: "reveal delay-2" , style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, color: '#9EA89C', lineHeight: 2.1, marginTop: 24, maxWidth: 640, margin: '24px auto 0', letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 171}}, "結合「仙佛加持 × 專業美容 × 外泌體育髮」"
            ...
            , React.createElement('div', { className: "recruit-steps-grid", style: { display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 20, marginBottom: 60 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 177}}
              , advantages.map((a, i) => (
                React.createElement('div', { key: a.title, className: `ing-circle reveal delay-${(i % 4) + 1}`, style: {
                  ...
                  , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 24, fontWeight: 500, color: '#C5A059', letterSpacing: '0.05em', marginBottom: 12 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 184}}, a.title)
                  , React.createElement('div', { style: { width: 28, height: 1, background: 'rgba(197,160,89,0.4)', margin: '0 auto 14px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 185}} )
                  , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#9EA89C', lineHeight: 2, letterSpacing: '0.05em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 186}}, a.desc)
                )
              ))
            )
            , React.createElement('div', { style: { textAlign: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 190}}
              , React.createElement('p', { className: "reveal", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: '#9EA89C', marginBottom: 16, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 191}}, "適合：家庭主婦、二度就業者、創業新手，歡迎任何對美容美髮充滿熱情的你"

              )
              , React.createElement('p', { className: "reveal delay-1" , style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: 'rgba(197,160,89,0.8)', marginBottom: 40, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 194}}, "📞 0927-186-901  ·  ✉️ acandy135789@gmail.com"
