    ...
    function Nav({ activePage, onNavigate }) {
      ...
      return (
        React.createElement('nav', { style: {
          ...
          borderBottom: `1px solid ${isOpaque ? 'rgba(82,58,52,0.22)' : 'transparent'}`,
          ...
          , React.createElement('div', { style: { maxWidth: 1440, margin: '0 auto', padding: '0 32px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 76 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 50}}
            ...
            , React.createElement('a', { href: "#", onClick: e => { e.preventDefault(); onNavigate('home'); }, style: { textDecoration: 'none', flexShrink: 0, cursor: 'pointer' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 52}}
              , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 23, fontWeight: 500, letterSpacing: '0.12em', color: '#523A34', lineHeight: 1 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 53}}, "Magic Garden 美肌花園"

              )
              , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 12, letterSpacing: '0.45em', color: '#8B6B5E', marginTop: 4 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 56}}, "ENERGY · BEAUTY · VITALITY"
              ...
              , links.map(l => (
                React.createElement('a', { key: l.label, href: "#", className: "nav-link",
                  ...
                  style: {
                    ...
                    color: activePage === l.page ? '#523A34' : '#7A5548',
                    textDecoration: 'none', whiteSpace: 'nowrap', cursor: 'pointer',
                    borderBottom: activePage === l.page ? '1px solid rgba(82,58,52,0.5)' : 'none',
                    paddingBottom: 2,
                  },
                  onMouseEnter: e => e.currentTarget.style.color = '#523A34',
                  onMouseLeave: e => e.currentTarget.style.color = activePage === l.page ? '#523A34' : '#7A5548', __self: this, __source: {fileName: _jsxFileName, lineNumber: 63}}
, l.label)
              ))
        ...
        React.createElement('section', { id: "home", className: "hero-bg", style: { position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'center', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 88}}
          ...
          , [
            ...
            React.createElement('div', { key: i, className: "orb", style: {
              ...
              background: 'radial-gradient(circle, rgba(82,58,52,0.9), rgba(82,58,52,0.1))',
              boxShadow: '0 0 8px rgba(82,58,52,0.6)',
          ...
          , React.createElement('div', { className: "hero-inner", style: { position: 'relative', zIndex: 3, maxWidth: 1380, margin: '0 auto', padding: '0 48px', width: '100%', paddingTop: 120 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 108}}
            ...
            , React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 20, marginBottom: 36, opacity: 0, animation: 'fadeSlide 1.2s ease 0.4s forwards' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 110}}
              ...
              , React.createElement('span', { style: { fontFamily: 'Cinzel, serif', fontSize: 16, letterSpacing: '0.45em', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 112}}, "ENERGY BEAUTY · MAGIC GARDEN"
            ...
            , React.createElement('h1', { className: "hero-h1", style: {
              ...
              , React.createElement('em', { style: { fontStyle: 'italic', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 125}}, "喚醒你的美麗魔法")
            )

            , React.createElement('p', { style: {
              fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300,
              color: '#8B6B5E', lineHeight: 2, marginTop: 28, maxWidth: 500,
            ...
            , React.createElement('div', { style: { display: 'flex', gap: 20, marginTop: 52, alignItems: 'center', opacity: 0, animation: 'fadeSlide 1.2s ease 1.3s forwards' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 139}}
              ...
              , React.createElement('a', { href: "#", onClick: e => { e.preventDefault(); onNavigate('founder'); }, style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: '#8B6B5E', textDecoration: 'none', letterSpacing: '0.1em', borderBottom: '1px solid rgba(158,168,156,0.4)', paddingBottom: 2, transition: 'color 0.3s', cursor: 'pointer' },
                onMouseEnter: e => e.currentTarget.style.color = '#523A34',
                onMouseLeave: e => e.currentTarget.style.color = '#8B6B5E', __self: this, __source: {fileName: _jsxFileName, lineNumber: 141}}
, "認識創辦人 →" )
            )

            , React.createElement('div', { className: "hero-stats", style: { display: 'flex', gap: 60, marginTop: 80, paddingTop: 40, borderTop: '1px solid rgba(82,58,52,0.15)', opacity: 0, animation: 'fadeSlide 1.2s ease 1.6s forwards' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 147}}
              , [
                { num: '9+',  label: '全台服務據點' },
                { num: '5+',  label: '專業美療項目' },
                ...
                React.createElement('div', { key: s.label, className: "hero-stat-item", __self: this, __source: {fileName: _jsxFileName, lineNumber: 153}}
                  , React.createElement('div', { className: "hero-stat-num", style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 36, fontWeight: 300, color: '#523A34', lineHeight: 1 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 154}}, s.num)
                  , React.createElement('div', { className: "hero-stat-label", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 16, color: '#8B6B5E', marginTop: 8, letterSpacing: '0.1em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 155}}, s.label)
                )
              ))
            )
          )
          ...
          , React.createElement('div', { className: "scroll-indicator", style: { position: 'absolute', bottom: 40, left: '50%', transform: 'translateX(-50%)', zIndex: 3, textAlign: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 161}}
            , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.4em', color: '#8B6B5E', marginBottom: 12 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 162}}, "SCROLL")
    ...
    function Marquee() {
      ...
      return (
        React.createElement('div', { style: { background: 'rgba(82,58,52,0.08)', borderTop: '1px solid rgba(82,58,52,0.15)', borderBottom: '1px solid rgba(82,58,52,0.15)', padding: '18px 0', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 188}}
          , React.createElement('div', { className: "marquee-track", __self: this, __source: {fileName: _jsxFileName, lineNumber: 189}}
            , items.map((w, i) => (
              React.createElement('span', { key: i, style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, letterSpacing: '0.2em', color: '#523A34', padding: '0 40px', whiteSpace: 'nowrap', opacity: 0.85 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 191}}
        ...
        React.createElement('section', { id: "founder", className: "sec-dark", style: { padding: '140px 0', position: 'relative', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 203}}
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto', padding: '0 48px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 204}}
            ...
            , React.createElement('div', { className: "reveal-left", __self: this, __source: {fileName: _jsxFileName, lineNumber: 206}}
              , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.5em', color: '#523A34', marginBottom: 24 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 207}}, "FOUNDER'S STORY" )
              , React.createElement('div', { className: "gold-line-left", __self: this, __source: {fileName: _jsxFileName, lineNumber: 208}} )
              , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 100, fontWeight: 300, color: 'rgba(82,58,52,0.06)', lineHeight: 1, marginBottom: -30, userSelect: 'none' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 209}}, "Momo")

              , React.createElement('h2', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(2rem, 3.5vw, 3rem)', fontWeight: 400, color: '#523A34', lineHeight: 1.3, letterSpacing: '0.02em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 211}}, "從敏感肌的困擾"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 212}} )
                , React.createElement('em', { style: { fontStyle: 'italic', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 213}}, "到美麗的魔法師")
              )

              , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300, color: '#8B6B5E', lineHeight: 2.2, marginTop: 32, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 216}}, "創辦人 Momo 自國中起即飽受嚴重敏感肌困擾——臉頰長期泛紅、反覆長痘，縱使嘗試各大專業品牌與皮膚科治療，症狀始終未能改善。因從小參與舞蹈表演，對外貌十分在意，肌膚問題帶來的困擾更加深刻。"

              )
              , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300, color: '#8B6B5E', lineHeight: 2.2, marginTop: 16, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 219}}, "17歲時，Momo 遠赴韓國深入研究，親身試用超過 30 種護膚配方，終於找到真正穩定膚況的解方。18歲正式創立 Magic Garden 美肌花園，取得多個韓國品牌台灣總代理權，並取得外泌體原液的台灣獨家專利技術，將科技美容與育髮帶入全新境界。"

              )
              , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300, color: '#8B6B5E', lineHeight: 2.2, marginTop: 16, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 222}}, "品牌名稱 Magic Garden，源自她對護膚的信念——保養品擁有讓人重拾自信、如花朵般盛放的「魔法」力量。"
              ...
              , React.createElement('div', { style: { display: 'flex', gap: 40, marginTop: 48 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 226}}
                , [['17歲', '赴韓研究護膚'], ['30+', '親試護膚配方'], ['18歲', '創立品牌・取得授權']].map(([t, d]) => (
                  React.createElement('div', { key: t, __self: this, __source: {fileName: _jsxFileName, lineNumber: 228}}
                    , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 26, color: '#523A34', fontWeight: 500, letterSpacing: '0.1em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 229}}, t)
                    , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 16, color: '#8B6B5E', marginTop: 6, letterSpacing: '0.06em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 230}}, d)
                  )
                ))
              )
            )
            ...
            , React.createElement('div', { className: "reveal-right", style: { position: 'relative' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 236}}
              , React.createElement('div', { style: { position: 'absolute', top: -20, right: -20, width: '100%', height: '100%', border: '1px solid rgba(82,58,52,0.2)', zIndex: 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 237}} )
              , React.createElement('div', { style: { position: 'relative', zIndex: 1, overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 238}}
                ...
                , React.createElement('div', { style: { position: 'absolute', bottom: 0, left: 0, right: 0, background: 'linear-gradient(transparent, rgba(6,13,6,0.88))', padding: '40px 32px 28px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 245}}
                  , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 19, color: '#523A34', letterSpacing: '0.25em', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 246}}, "\"幫助更多人重拾自信，從美麗開始盛放\""
        ...
        React.createElement('section', { style: { background: 'linear-gradient(150deg, #FFFBF9 0%, #F7D6C8 100%)', padding: '100px 48px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 269}}
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 270}}
            , React.createElement('div', { style: { textAlign: 'center', marginBottom: 64 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 271}}
              , React.createElement('div', { className: "reveal", style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 272}}, "EXPLORE")
              , React.createElement('span', { className: "gold-line", __self: this, __source: {fileName: _jsxFileName, lineNumber: 273}} )
              , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 400, color: '#523A34', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 274}}, "探索我們的世界"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 275}} ), React.createElement('em', { style: { color: '#523A34', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 275}}, "Magic Garden 美肌花園"  )
              )
            )
            , React.createElement('div', { style: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24, marginBottom: 24 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 278}}
              , sections.slice(0, 6).map((s, i) => (
                React.createElement('div', { key: s.title, className: `ing-circle reveal delay-${(i % 3) + 1}`,
                  ...
                  , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.35em', color: '#8B6B5E', marginBottom: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 287}}, s.en)
                  , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 26, fontWeight: 500, color: '#523A34', letterSpacing: '0.05em', marginBottom: 12 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 288}}, s.title)
                  ...
                  , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#8B6B5E', lineHeight: 2, letterSpacing: '0.06em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 290}}, s.desc)
                  , React.createElement('div', { style: { marginTop: 20, fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: 'rgba(82,58,52,0.7)', letterSpacing: '0.1em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 291}}, "了解更多 →" )
                )
              ))
            )
            , React.createElement('div', { className: "ing-circle reveal" ,
              ...
              , React.createElement('div', { style: { flex: 1 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 302}}
                , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.4em', color: '#8B6B5E', marginBottom: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 303}}, sections[6].en)
                , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 26, fontWeight: 500, color: '#523A34', letterSpacing: '0.05em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 304}}, sections[6].title)
                , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#8B6B5E', lineHeight: 2, letterSpacing: '0.06em', marginTop: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 305}}, sections[6].desc)
              )
              , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: 'rgba(82,58,52,0.7)', letterSpacing: '0.15em', flexShrink: 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 307}}, "了解更多 →" )
            )
          )
        )
      );
      ...
      return (
        React.createElement('section', { id: "hair", className: "sec-forest", style: { padding: '140px 0', position: 'relative', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 323}}
          , React.createElement('div', { style: { textAlign: 'center', marginBottom: 80 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 324}}
            , React.createElement('div', { className: "reveal", style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 325}}, "HAIR HEALTH TECHNOLOGY"  )
            , React.createElement('span', { className: "gold-line", __self: this, __source: {fileName: _jsxFileName, lineNumber: 326}} )
            , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(2rem, 3.5vw, 3.2rem)', fontWeight: 400, color: '#523A34', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 327}}, "開運科技健髮"
              , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 328}} ), React.createElement('em', { style: { color: '#523A34', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 328}}, "從頭皮開始，好好照顧自己")
            )
          )
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto', padding: '0 48px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, alignItems: 'start' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 331}}
            , React.createElement('div', { className: "svc-card reveal delay-1"  , style: { background: 'rgba(13,26,14,0.8)', backdropFilter: 'blur(8px)' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 332}}
              ...
              , React.createElement('div', { style: { padding: '40px 44px 48px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 339}}
                , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.5em', color: '#8B6B5E', marginBottom: 10 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 340}}, "EXOSOME HAIR TECHNOLOGY"  )
                , React.createElement('h3', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 28, fontWeight: 500, color: '#523A34', letterSpacing: '0.05em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 341}}, "外泌體頭皮深度修護")
                ...
                , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, fontWeight: 300, color: '#8B6B5E', lineHeight: 2.1, letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 343}}, "採用台灣獨家專利外泌體原液，結合科技儀器深入頭皮底層，有效改善掉髮、頭皮老化等問題，喚醒髮絲的生命力。每次療程皆由專業技術顧問一對一全程服務，並提供後續追蹤諮詢。"

                )
                , React.createElement('div', { style: { marginTop: 32, padding: '20px 24px', border: '1px solid rgba(82,58,52,0.25)', display: 'inline-block' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 346}}
                  , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.3em', color: '#8B6B5E', marginBottom: 4 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 347}}, "STARTING FROM" )
                  , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 38, color: '#523A34', fontWeight: 300 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 348}}, "NT$ 3,500" )
                  , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#8B6B5E', marginTop: 4 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 349}}, "單次體驗 · 套組方案另洽技師"  )
                )
              ...
              , features.map((f, i) => (
                React.createElement('div', { key: f.title, className: `ing-circle reveal delay-${(i % 3) + 1}`, style: { background: 'rgba(13,26,14,0.6)', padding: '28px 32px', backdropFilter: 'blur(8px)', display: 'flex', alignItems: 'flex-start', gap: 20 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 356}}
                  ...
                  , React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 358}}
                    , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 24, fontWeight: 500, color: '#523A34', letterSpacing: '0.06em', marginBottom: 10 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 359}}, f.title)
                    , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#8B6B5E', lineHeight: 2, letterSpacing: '0.06em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 360}}, f.desc)
                  )
                )
              ))
            )
        ...
        React.createElement('section', { style: { background: 'linear-gradient(150deg, #FFFBF9 0%, #F7D6C8 100%)', padding: '100px 0 140px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 382}}
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto', padding: '0 48px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 383}}
            , React.createElement('div', { style: { textAlign: 'center', marginBottom: 80 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 384}}
              , React.createElement('div', { className: "reveal", style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 385}}, "BEFORE · AFTER"  )
              , React.createElement('span', { className: "gold-line", __self: this, __source: {fileName: _jsxFileName, lineNumber: 386}} )
              , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 400, color: '#523A34', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 387}}, "客戶見證成果"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 388}} ), React.createElement('em', { style: { color: '#523A34', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 388}}, "真實案例・有目共睹")
              )
              , React.createElement('div', { style: { marginTop: 40, display: 'flex', flexDirection: 'column', gap: 20, alignItems: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 390}}
                , React.createElement('p', { className: "reveal delay-2" , style: { fontFamily: '"Noto Serif TC", serif', fontSize: 22, fontWeight: 400, color: '#523A34', letterSpacing: '0.1em', lineHeight: 1.8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 391}}, "你也想要這樣的改變嗎？"
                  , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 392}} ), React.createElement('span', { style: { fontSize: 18, color: '#8B6B5E' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 392}}, "如果這正是你在找的，我們聊聊")
                )
                , React.createElement('p', { className: "reveal delay-3" , style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: '#8B6B5E', letterSpacing: '0.08em', lineHeight: 2, maxWidth: 560 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 394}}, "你會為社交及外貌焦慮困擾嗎？"
                ...
                , React.createElement('div', { className: "reveal delay-3" , style: { marginTop: 8, padding: '18px 36px', border: '1px solid rgba(82,58,52,0.3)', display: 'inline-block' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 398}}
                  , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 13, letterSpacing: '0.4em', color: '#8B6B5E', marginBottom: 6 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 399}}, "SINGLE SESSION" )
                  , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 34, color: '#523A34', fontWeight: 300 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 400}}, "單堂體驗價 NT$ 3,500"  )
                  , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 16, color: '#8B6B5E', marginTop: 6 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 401}}, "儲值優惠請洽詢技術老師")
                )
              )
            )
            , React.createElement('div', { style: { position: 'relative', userSelect: 'none', maxWidth: 860, margin: '0 auto' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 405}}
              , React.createElement('div', { style: { textAlign: 'center', marginBottom: 32 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 406}}
                , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 'clamp(1.6rem, 3vw, 2.4rem)', fontWeight: 500, color: '#523A34', letterSpacing: '0.12em', lineHeight: 1.5 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 407}}, cur.caption)
              )
              , React.createElement('div', { style: { overflow: 'hidden', border: '1px solid rgba(82,58,52,0.2)' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 409}}
              ...
              , [{ fn: prev, side: { left: -28 }, ch: '‹' }, { fn: next, side: { right: -28 }, ch: '›' }].map(({ fn, side, ch }) => (
                React.createElement('button', { key: ch, onClick: fn, style: {
                  ...
                  width: 52, height: 52, borderRadius: '50%', background: 'rgba(247,214,200,0.82)',
                  border: '1px solid rgba(82,58,52,0.4)', color: '#523A34', fontSize: 26, cursor: 'pointer',
                  display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.3s',
                },
                  onMouseEnter: e => { e.currentTarget.style.background = 'rgba(82,58,52,0.2)'; e.currentTarget.style.borderColor = '#523A34'; },
                  onMouseLeave: e => { e.currentTarget.style.background = 'rgba(247,214,200,0.82)'; e.currentTarget.style.borderColor = 'rgba(82,58,52,0.4)'; }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 413}}
, ch)
              ))
              , React.createElement('div', { style: { display: 'flex', justifyContent: 'center', gap: 10, marginTop: 24 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 423}}
                , slides.map((_, i) => (
                  React.createElement('button', { key: i, onClick: () => setSlide(i), style: {
                    ...
                    background: i === slide ? '#523A34' : 'rgba(82,58,52,0.3)', transition: 'all 0.3s', padding: 0,
    ...
    function HairCustomerShares() {
      ...
      return (
        React.createElement('section', { style: { background: '#FFFBF9', padding: '100px 0 140px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 450}}
          , React.createElement('div', { style: { maxWidth: 860, margin: '0 auto', padding: '0 48px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 451}}
            , React.createElement('div', { style: { textAlign: 'center', marginBottom: 80 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 452}}
              , React.createElement('div', { className: "reveal", style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 453}}, "CUSTOMER STORIES" )
              , React.createElement('span', { className: "gold-line", __self: this, __source: {fileName: _jsxFileName, lineNumber: 454}} )
              , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 400, color: '#523A34', lineHeight: 1.4 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 455}}, "顧客健髮喜悅分享"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 456}} )
                , React.createElement('em', { style: { color: '#523A34', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 457}}, "真實見證・用心陪伴")
              )
              , React.createElement('p', { className: "reveal delay-2" , style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, color: '#8B6B5E', lineHeight: 2.2, marginTop: 28, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 459}}, "每一張照片背後，都是一段從擔心到放心的旅程。"
            ...
            , React.createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: 48 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 464}}
              , photos.map((p, i) => (
                React.createElement('div', { key: i, className: `reveal delay-${(i % 3) + 1}`, style: { border: '1px solid rgba(82,58,52,0.15)' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 466}}
                  ...
                  , React.createElement('div', { style: { padding: '20px 28px', background: 'rgba(13,26,14,0.7)' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 468}}
                    , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#523A34', letterSpacing: '0.1em', margin: 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 469}}, p.caption)
                  )
                )
              ))
            )
    ...
    function BeautyCare() {
      ...
      return (
        React.createElement('section', { id: "beauty", className: "sec-dark", style: { padding: '140px 0', position: 'relative', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 514}}
          , React.createElement('div', { style: { position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontFamily: '"Cormorant Garamond", serif', fontSize: 180, fontWeight: 700, color: 'rgba(82,58,52,0.025)', whiteSpace: 'nowrap', userSelect: 'none', pointerEvents: 'none' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 515}}, "BEAUTY"
          ...
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto', padding: '0 48px', position: 'relative' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 519}}
            ...
            , React.createElement('div', { style: { textAlign: 'center', marginBottom: 80 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 521}}
              , React.createElement('div', { className: "reveal", style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 522}}, "TECHNOLOGY BEAUTY CARE"  )
              , React.createElement('span', { className: "gold-line", __self: this, __source: {fileName: _jsxFileName, lineNumber: 523}} )
              , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(2rem, 3.5vw, 3.2rem)', fontWeight: 400, color: '#523A34', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 524}}, "開運科技美容"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 525}} )
                , React.createElement('em', { style: { color: '#523A34', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 526}}, "韓國頂級護膚技術")
              )
              , React.createElement('p', { className: "reveal delay-2" , style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: '#8B6B5E', lineHeight: 2, marginTop: 20, letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 528}}, "全程使用韓國原廠進口護膚品 · 教育導向服務理念 · 讓您真正了解自己的肌膚"
              ...
              , treatments.slice(0, 3).map((t, i) => (
                React.createElement('div', { key: t.id, className: `svc-card reveal delay-${i + 1}`, style: { background: 'rgba(13,26,14,0.8)', backdropFilter: 'blur(8px)' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 535}}
                  ...
                  , React.createElement('div', { style: { padding: '28px 32px 36px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 539}}
                    , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 13, letterSpacing: '0.4em', color: '#8B6B5E', marginBottom: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 540}}, t.en)
                    , React.createElement('div', { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 541}}
                      , React.createElement('h3', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 25, fontWeight: 500, color: '#523A34', letterSpacing: '0.05em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 542}}, t.title)
                      , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 40, fontWeight: 300, color: 'rgba(82,58,52,0.2)', lineHeight: 1 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 543}}, t.id)
                    )
                    ...
                    , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, fontWeight: 300, color: '#8B6B5E', lineHeight: 2, letterSpacing: '0.06em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 546}}, t.desc)
                    , React.createElement('div', { style: { marginTop: 14, fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: 'rgba(82,58,52,0.65)', letterSpacing: '0.04em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 547}}, t.suitable)
                  )
                )
              ))
            )
              ...
              , treatments.slice(3).map((t, i) => (
                React.createElement('div', { key: t.id, className: `svc-card reveal delay-${i + 1}`, style: { background: 'rgba(13,26,14,0.8)', backdropFilter: 'blur(8px)', display: 'flex' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 555}}
                  ...
                  , React.createElement('div', { style: { padding: '28px 32px', flex: 1 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 559}}
                    , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 13, letterSpacing: '0.4em', color: '#8B6B5E', marginBottom: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 560}}, t.en)
                    , React.createElement('div', { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 561}}
                      , React.createElement('h3', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 24, fontWeight: 500, color: '#523A34', letterSpacing: '0.05em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 562}}, t.title)
                      , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 36, fontWeight: 300, color: 'rgba(82,58,52,0.2)', lineHeight: 1 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 563}}, t.id)
                    )
                    ...
                    , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, fontWeight: 300, color: '#8B6B5E', lineHeight: 2, letterSpacing: '0.06em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 566}}, t.desc)
                    , React.createElement('div', { style: { marginTop: 12, fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: 'rgba(82,58,52,0.65)', letterSpacing: '0.04em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 567}}, t.suitable)
                  )
                )
              ))
            )
      ...
      return (
        React.createElement(React.Fragment, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 589}}
          , React.createElement('section', { style: { background: 'linear-gradient(135deg, #060d06 0%, #0d1a0e 50%, #060d06 100%)', padding: '140px 0', position: 'relative', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 590}}
            , React.createElement('div', { style: { position: 'absolute', top: 0, right: 0, width: '40%', height: '100%', background: 'rgba(82,58,52,0.025)', clipPath: 'polygon(20% 0, 100% 0, 100% 100%, 0 100%)' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 591}} )
            , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto', padding: '0 48px', position: 'relative' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 592}}
              , React.createElement('div', { style: { textAlign: 'center', marginBottom: 80 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 593}}
                , React.createElement('div', { className: "reveal", style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 594}}, "MIND · BODY · SPIRIT"    )
                , React.createElement('span', { className: "gold-line", __self: this, __source: {fileName: _jsxFileName, lineNumber: 595}} )
                , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(2rem, 3.5vw, 3.2rem)', fontWeight: 400, color: '#523A34', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 596}}, "身心靈整體調理"
                  , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 597}} ), React.createElement('em', { style: { color: '#523A34', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 597}}, "能量共振・內外兼修")
                )
              )
              , React.createElement('div', { style: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 28 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 600}}
                , items.map((item, i) => (
                  React.createElement('div', { key: item.title, className: `ing-circle reveal delay-${i + 1}`, style: { background: 'rgba(13,26,14,0.6)', padding: '52px 40px', backdropFilter: 'blur(8px)', textAlign: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 602}}
                    ...
                    , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.4em', color: '#523A34', marginBottom: 12 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 604}}, item.en)
                    , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 24, fontWeight: 500, color: '#523A34', letterSpacing: '0.05em', marginBottom: 16 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 605}}, item.title)
                    , React.createElement('div', { style: { width: 40, height: 1, background: 'rgba(82,58,52,0.4)', margin: '0 auto 20px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 606}} )
                    , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: '#8B6B5E', lineHeight: 2.1, letterSpacing: '0.06em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 607}}, item.desc)
                  )
                ))
              )
          ...
          , React.createElement('section', { style: { background: 'linear-gradient(150deg, #FFFBF9 0%, #F7D6C8 100%)', padding: '100px 0 140px', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 618}}
            , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto', padding: '0 48px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 619}}
              , React.createElement('div', { className: "reveal-right", style: { position: 'relative' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 620}}
                , React.createElement('div', { style: { position: 'absolute', top: -20, left: -20, width: '100%', height: '100%', border: '1px solid rgba(82,58,52,0.2)', zIndex: 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 621}} )
              ...
              , React.createElement('div', { className: "reveal-left", __self: this, __source: {fileName: _jsxFileName, lineNumber: 626}}
                , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.5em', color: '#523A34', marginBottom: 24 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 627}}, "MIND · BODY · SPIRIT DANCE"     )
                , React.createElement('div', { className: "gold-line-left", __self: this, __source: {fileName: _jsxFileName, lineNumber: 628}} )
                , React.createElement('h2', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(2rem, 3.5vw, 3rem)', fontWeight: 400, color: '#523A34', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 629}}, "身心靈舞蹈"
                  , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 630}} ), React.createElement('em', { style: { fontStyle: 'italic', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 630}}, "讓身體回到順・心回到靜")
                )
                , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300, color: '#8B6B5E', lineHeight: 2.2, marginTop: 32, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 632}}, "這不是「再學更多」的課程，而是釋放你長久積累緊繃的旅程。透過溫柔的身體引導、呼吸技術與能量流設計，針對那些你平常用不到、卻不斷在承受壓力的身體部位。"

                )
                , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300, color: '#8B6B5E', lineHeight: 2.2, marginTop: 16, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 635}}, "「身心靈覺察・重塑流動工作坊」結合運動科學原理與能量優化方法，透過啟動正確的肌肉連結，打破疼痛循環，恢復動態美學。"
                ...
                , React.createElement('div', { style: { display: 'flex', gap: 40, marginTop: 48, flexWrap: 'wrap' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 638}}
                  , [['精準感知','覺察身體細微訊號'],['導正慣性','修正長期代償模式'],['動態美學','重塑流暢的生命律動']].map(([t,d]) => (
                    React.createElement('div', { key: t, __self: this, __source: {fileName: _jsxFileName, lineNumber: 640}}
                      , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 22, color: '#523A34', fontWeight: 500, letterSpacing: '0.1em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 641}}, t)
                      , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 15, color: '#8B6B5E', marginTop: 6, letterSpacing: '0.06em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 642}}, d)
                    )
                  ))
                )
                , React.createElement('div', { style: { marginTop: 40 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 646}}
                  , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: 'rgba(82,58,52,0.8)', letterSpacing: '0.05em', marginBottom: 24 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 647}}, "✓ 完全初學者亦適合 · 持續改善而非暫時紓緩"   )
          ...
          , React.createElement('section', { style: { background: 'linear-gradient(150deg, #F7D6C8 0%, #E2C2B9 100%)', padding: '100px 0 140px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 655}}
            , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto', padding: '0 48px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 656}}
              , React.createElement('div', { className: "reveal-left", __self: this, __source: {fileName: _jsxFileName, lineNumber: 657}}
                , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.5em', color: '#523A34', marginBottom: 24 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 658}}, "DIVINATION · FORTUNE READING"   )
                , React.createElement('div', { className: "gold-line-left", __self: this, __source: {fileName: _jsxFileName, lineNumber: 659}} )
                , React.createElement('h2', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(2rem, 3.5vw, 3rem)', fontWeight: 400, color: '#523A34', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 660}}, "神籤占卜"
                  , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 661}} ), React.createElement('em', { style: { fontStyle: 'italic', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 661}}, "指引方向・開啟好運")
                )
                , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300, color: '#8B6B5E', lineHeight: 2.2, marginTop: 32, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 663}}, "結合傳統命理智慧與現代能量療法，透過神籤占卜為您解讀當下運勢、制定個人化的開運方案，讓美容護膚與人生運勢相輔相成。"

                )
                , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300, color: '#8B6B5E', lineHeight: 2.2, marginTop: 16, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 666}}, "無論您面臨感情、事業、健康或人際關係的困惑，神籤占卜都能為您帶來清晰的指引，全面提升您的氣場與正向磁場。"
              ...
              , React.createElement('div', { className: "reveal-right", style: { position: 'relative' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 671}}
                , React.createElement('div', { style: { position: 'absolute', top: -20, right: -20, width: '100%', height: '100%', border: '1px solid rgba(82,58,52,0.2)', zIndex: 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 672}} )
        ...
        React.createElement('section', { id: "team", className: "sec-forest", style: { padding: '140px 0', position: 'relative', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 692}}
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto', padding: '0 48px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 100, alignItems: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 693}}
            , React.createElement('div', { className: "reveal-left", __self: this, __source: {fileName: _jsxFileName, lineNumber: 694}}
              , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 695}}, "ABOUT OUR TEAM"  )
              , React.createElement('span', { className: "gold-line-left", __self: this, __source: {fileName: _jsxFileName, lineNumber: 696}} )
              , React.createElement('h2', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(2rem, 3.5vw, 3.2rem)', fontWeight: 400, color: '#523A34', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 697}}, "關於我們的團隊"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 698}} ), React.createElement('em', { style: { color: '#523A34', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 698}}, "相同熱情・共同使命")
              )
              , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300, color: '#8B6B5E', lineHeight: 2.2, marginTop: 32, letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 700}}, "我們是一群來自不同背景、懷抱相同熱情的人，擁有一致的信念——幫助那些願意努力改變生活的人。"

              )
              , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300, color: '#8B6B5E', lineHeight: 2.2, marginTop: 16, letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 703}}, "我們相信每位成員都值得被看見，無論背景如何。Magic Garden 不只是一個品牌，更是一個讓人重拾自信、綻放光芒的能量場域。我們以三大核心支柱為基礎，提供全方位的美麗解決方案。"
            ...
            , React.createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 710}}
              ...
              , pillars.map((p, i) => (
                React.createElement('div', { key: p.n, className: `reveal delay-${i + 1}`, style: { display: 'flex', alignItems: 'flex-start', gap: 28, padding: '32px 0', borderBottom: '1px solid rgba(82,58,52,0.1)' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 716}}
                  , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 18, color: '#523A34', fontWeight: 500, letterSpacing: '0.15em', flexShrink: 0, paddingTop: 4 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 717}}, p.n)
                  , React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 718}}
                    , React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 14, marginBottom: 10 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 719}}
                      , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 26, fontWeight: 500, color: '#523A34', letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 720}}, p.title)
                      , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.3em', color: '#8B6B5E' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 721}}, p.en)
                    )
                    , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#8B6B5E', lineHeight: 2, letterSpacing: '0.06em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 723}}, p.desc)
                  )
                )
              ))
            )
    ...
    function PartnerInfo() {
      ...
      return (
        React.createElement('section', { id: "partners", className: "sec-dark", style: { padding: '140px 0', position: 'relative', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 749}}
          , React.createElement('div', { style: { position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontFamily: '"Cormorant Garamond", serif', fontSize: 160, fontWeight: 700, color: 'rgba(82,58,52,0.025)', whiteSpace: 'nowrap', userSelect: 'none', pointerEvents: 'none' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 750}}, "PARTNERS"
          ...
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto', padding: '0 48px', position: 'relative' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 754}}
            , React.createElement('div', { style: { textAlign: 'center', marginBottom: 80 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 755}}
              , React.createElement('div', { className: "reveal", style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 756}}, "PARTNER LOCATIONS" )
              , React.createElement('span', { className: "gold-line", __self: this, __source: {fileName: _jsxFileName, lineNumber: 757}} )
              , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(2rem, 3.5vw, 3.2rem)', fontWeight: 400, color: '#523A34', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 758}}, "夥伴資訊"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 759}} )
                , React.createElement('em', { style: { color: '#523A34', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 760}}, "全桃園服務據點")
              )
              , React.createElement('p', { className: "reveal delay-2" , style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: '#8B6B5E', lineHeight: 2, marginTop: 20, letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 762}}, "桃園各區皆有專業技師駐點服務 · LINE 預約 · 貴賓優先制"
              ...
              , partners.map((p, i) => (
                React.createElement('div', { key: `${p.name}-${i}`, className: `testi-card reveal delay-${(i % 4) + 1}`, style: {
                  ...
                  , React.createElement('div', { style: { padding: '28px 28px 32px', flex: 1, display: 'flex', flexDirection: 'column' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 780}}
                    , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.15em', color: '#523A34', marginBottom: 14, opacity: 0.8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 781}}, p.shop)
                    , React.createElement('div', { style: { display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 10, gap: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 782}}
                      , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 25, fontWeight: 500, color: '#523A34', letterSpacing: '0.06em', lineHeight: 1.2 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 783}}, p.name)
                      , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 15, letterSpacing: '0.12em', color: '#523A34', border: '1px solid rgba(82,58,52,0.35)', padding: '4px 10px', whiteSpace: 'nowrap', flexShrink: 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 784}}, p.area)
                    )
                    ...
                    , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#8B6B5E', letterSpacing: '0.07em', marginBottom: 10 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 787}}, p.role)
                    , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#7A5548', letterSpacing: '0.06em', lineHeight: 1.9, marginBottom: p.feature ? 8 : 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 788}}
                      , React.createElement('span', { style: { color: 'rgba(82,58,52,0.7)', fontSize: 16 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 789}}, "專長｜"), p.specialty
                    )
                    , p.feature && (
                      React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#7A5548', letterSpacing: '0.06em', lineHeight: 1.9 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 792}}
                        , React.createElement('span', { style: { color: 'rgba(82,58,52,0.7)', fontSize: 16 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 793}}, "特點｜"), p.feature
                      )
                    )
                    , React.createElement('div', { style: { marginTop: 'auto', paddingTop: 20, display: 'flex', alignItems: 'center', gap: 16 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 796}}
                      , p.qr ? (
                        React.createElement('img', { src: p.qr, alt: `${p.name} LINE QR`, style: { width: 72, height: 72, objectFit: 'contain', border: '1px solid rgba(82,58,52,0.25)', padding: 4, background: '#fff' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 798}} )
                      ) : (
                        React.createElement('div', { style: { width: 72, height: 72, border: '1px dashed rgba(82,58,52,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 800}}
                          , React.createElement('span', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 15, color: '#8B6B5E', textAlign: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 801}}, "QR 圖檔待補" )
                        )
                      )
                      , React.createElement('a', { href: p.line || '#', target: "_blank", rel: "noopener noreferrer" ,
                        style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, letterSpacing: '0.2em', color: 'rgba(82,58,52,0.85)', border: '1px solid rgba(82,58,52,0.3)', padding: '10px 20px', textDecoration: 'none', display: 'inline-block', transition: 'all 0.3s' },
                        onMouseEnter: e => { e.currentTarget.style.background = 'rgba(82,58,52,0.12)'; e.currentTarget.style.borderColor = '#523A34'; },
                        onMouseLeave: e => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.borderColor = 'rgba(82,58,52,0.3)'; }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 804}}
, "LINE 預約" )
                    )
                  )
                )
        ...
        React.createElement('section', { id: "recruit", style: {
          ...
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 836}}
            , React.createElement('div', { style: { textAlign: 'center', marginBottom: 80 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 837}}
              , React.createElement('div', { className: "reveal", style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 838}}, "JOIN US" )
              , React.createElement('span', { className: "gold-line", __self: this, __source: {fileName: _jsxFileName, lineNumber: 839}} )
              , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(2rem, 3.5vw, 3.2rem)', fontWeight: 400, color: '#523A34', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 840}}, "夥伴招募"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 841}} )
                , React.createElement('em', { style: { color: '#523A34', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 842}}, "與我們一起改變人生")
              )
              , React.createElement('p', { className: "reveal delay-2" , style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, color: '#8B6B5E', lineHeight: 2.1, marginTop: 24, maxWidth: 640, margin: '24px auto 0', letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 844}}, "結合「仙佛加持 × 專業美容 × 外泌體育髮」"
            ...
            , React.createElement('div', { style: { display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 20, marginBottom: 60 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 851}}
              , advantages.map((a, i) => (
                React.createElement('div', { key: a.title, className: `ing-circle reveal delay-${(i % 4) + 1}`, style: {
                  ...
                  , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 24, fontWeight: 500, color: '#523A34', letterSpacing: '0.05em', marginBottom: 12 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 860}}, a.title)
                  , React.createElement('div', { style: { width: 28, height: 1, background: 'rgba(82,58,52,0.4)', margin: '0 auto 14px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 861}} )
                  , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#8B6B5E', lineHeight: 2, letterSpacing: '0.05em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 862}}, a.desc)
                )
              ))
            )

            , React.createElement('div', { style: { textAlign: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 867}}
              , React.createElement('p', { className: "reveal", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: '#8B6B5E', marginBottom: 16, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 868}}, "適合：家庭主婦、二度就業者、創業新手，歡迎任何對美容美髮充滿熱情的你"

              )
              , React.createElement('p', { className: "reveal delay-1" , style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: 'rgba(82,58,52,0.8)', marginBottom: 40, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 871}}, "📞 0927-186-901  ·  ✉️ acandy135789@gmail.com"
    ...
    function Footer({ onNavigate }) {
      ...
      return (
        React.createElement('footer', { style: { background: '#FFFBF9', borderTop: '1px solid rgba(82,58,52,0.15)', padding: '80px 48px 40px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 907}}
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 908}}

            , React.createElement('div', { style: { display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 60, paddingBottom: 60, borderBottom: '1px solid rgba(82,58,52,0.1)' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 910}}

              , React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 912}}
                , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 26, fontWeight: 500, letterSpacing: '0.15em', color: '#523A34', marginBottom: 4 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 913}}, "Magic Garden 美肌花園"  )
                , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 13, letterSpacing: '0.45em', color: '#8B6B5E', marginBottom: 24 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 914}}, "ENERGY · BEAUTY · VITALITY"    )
                , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#8B6B5E', lineHeight: 2.2, letterSpacing: '0.07em', maxWidth: 300 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 915}}, "能量美學品牌 · 開運美容護膚／秀髮養育"
                ...
                , React.createElement('div', { style: { marginTop: 20 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 919}}
                  , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#7A5548', letterSpacing: '0.07em', marginBottom: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 920}}, "📞 0927-186-901" )
                  , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#7A5548', letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 921}}, "✉️ acandy135789@gmail.com" )
                )
              )

              , cols.map(col => (
                React.createElement('div', { key: col.title, __self: this, __source: {fileName: _jsxFileName, lineNumber: 926}}
                  , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.35em', color: '#523A34', marginBottom: 24 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 927}}, col.title)
                      ...
                      l.type === 'phone' ? (
                        React.createElement('div', { key: l.label, style: { position: 'relative' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 931}}
                          , React.createElement('span', { onClick: () => setPhoneOpen(o => !o), style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#8B6B5E', letterSpacing: '0.07em', cursor: 'pointer', transition: 'color 0.3s' },
                            onMouseEnter: e => e.currentTarget.style.color = '#523A34',
                            onMouseLeave: e => e.currentTarget.style.color = '#8B6B5E', __self: this, __source: {fileName: _jsxFileName, lineNumber: 932}}
, l.label)
                          , phoneOpen && (
                            ...
                            , React.createElement('div', { style: { position: 'absolute', left: 0, top: '110%', background: 'rgba(13,26,14,0.97)', border: '1px solid rgba(82,58,52,0.3)', padding: '12px 20px', zIndex: 100, display: 'flex', flexDirection: 'column', gap: 12 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 939}}
                              , React.createElement('a', { href: "tel:0906607856", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#523A34', textDecoration: 'none', letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 940}}, "0906-607-856")
                              , React.createElement('a', { href: "tel:0927186901", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#523A34', textDecoration: 'none', letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 941}}, "0927-186-901")
                            )
                            )
                          )
                        )
                        ...
                        React.createElement('div', { key: l.label, style: { position: 'relative' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 947}}
                          , React.createElement('span', { onClick: () => setEmailOpen(o => !o), style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#8B6B5E', letterSpacing: '0.07em', cursor: 'pointer', transition: 'color 0.3s' },
                            onMouseEnter: e => e.currentTarget.style.color = '#523A34',
                            onMouseLeave: e => e.currentTarget.style.color = '#8B6B5E', __self: this, __source: {fileName: _jsxFileName, lineNumber: 948}}
, l.label)
                          , emailOpen && (
                            ...
                            , React.createElement('div', { style: { position: 'absolute', left: 0, top: '110%', background: 'rgba(13,26,14,0.97)', border: '1px solid rgba(82,58,52,0.3)', padding: '12px 20px', zIndex: 100 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 955}}
                              , React.createElement('a', { href: "mailto:acandy135789@gmail.com", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#523A34', textDecoration: 'none', letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 956}}, "acandy135789@gmail.com")
                            )
                            )
                          )
                        )
                        ...
                        React.createElement('a', { key: l.label, href: l.href,
                          style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#8B6B5E', textDecoration: 'none', letterSpacing: '0.07em', transition: 'color 0.3s' },
                          onMouseEnter: e => e.currentTarget.style.color = '#523A34',
                          onMouseLeave: e => e.currentTarget.style.color = '#8B6B5E', __self: this, __source: {fileName: _jsxFileName, lineNumber: 962}}
, l.label)
                      ) : (
                        React.createElement('a', { key: l.label, href: "#",
                          onClick: e => { e.preventDefault(); if (l.page) onNavigate(l.page); },
                          style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#8B6B5E', textDecoration: 'none', letterSpacing: '0.07em', transition: 'color 0.3s', cursor: l.page ? 'pointer' : 'default' },
                          onMouseEnter: e => e.currentTarget.style.color = '#523A34',
                          onMouseLeave: e => e.currentTarget.style.color = '#8B6B5E', __self: this, __source: {fileName: _jsxFileName, lineNumber: 968}}
, l.label)
                      )
                    ))
                  )
