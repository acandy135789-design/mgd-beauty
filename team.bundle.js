        ...
        React.createElement('section', { className: "sec-forest", style: { padding: '140px 0', position: 'relative', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 155}}
          , React.createElement('div', { className: "two-col-grid", style: { maxWidth: 1380, margin: '0 auto', padding: '0 48px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 100, alignItems: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 156}}
            , React.createElement('div', { className: "reveal-left", __self: this, __source: {fileName: _jsxFileName, lineNumber: 157}}
              , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 158}}, "ABOUT OUR TEAM"  )
              , React.createElement('span', { className: "gold-line-left", __self: this, __source: {fileName: _jsxFileName, lineNumber: 159}} )
              , React.createElement('h2', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(2rem, 3.5vw, 3.2rem)', fontWeight: 400, color: '#523A34', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 160}}, "關於我們的團隊"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 161}} )
                , React.createElement('em', { style: { color: '#523A34', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 162}}, "相同熱情・共同使命")
              )
              , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300, color: '#8B6B5E', lineHeight: 2.2, marginTop: 32, letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 164}}, "我們是一群來自不同背景、懷抱相同熱情的人，擁有一致的信念——幫助那些願意努力改變生活的人。"

              )
              , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300, color: '#8B6B5E', lineHeight: 2.2, marginTop: 16, letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 167}}, "我們相信每位成員都值得被看見，無論背景如何。Magic Garden 不只是一個品牌，更是一個讓人重拾自信、綻放光芒的能量場域。我們以三大核心支柱為基礎，提供全方位的美麗解決方案。"
            ...
            , React.createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 176}}
              ...
              , pillars.map((p, i) => (
                React.createElement('div', { key: p.n, className: `reveal delay-${i + 1}`, style: {
                  ...
                  padding: '32px 0', borderBottom: '1px solid rgba(82,58,52,0.1)',
                }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 185}}
                  , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 18, color: '#523A34', fontWeight: 500, letterSpacing: '0.15em', flexShrink: 0, paddingTop: 4 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 189}}, p.n)
                  , React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 190}}
                    , React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 14, marginBottom: 10 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 191}}
                      , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 26, fontWeight: 500, color: '#523A34', letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 192}}, p.title)
                      , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.3em', color: '#8B6B5E' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 193}}, p.en)
                    )
                    , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#8B6B5E', lineHeight: 2, letterSpacing: '0.06em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 195}}, p.desc)
                  )
                )
              ))
            )
