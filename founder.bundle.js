        ...
        React.createElement('section', { className: "sec-dark", style: { padding: '140px 0', position: 'relative', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 149}}
          , React.createElement('div', { className: "two-col-grid", style: { maxWidth: 1380, margin: '0 auto', padding: '0 48px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 150}}
            , React.createElement('div', { className: "reveal-left", __self: this, __source: {fileName: _jsxFileName, lineNumber: 151}}
              , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.5em', color: '#523A34', marginBottom: 24 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 152}}, "FOUNDER'S STORY" )
              , React.createElement('div', { className: "gold-line-left", __self: this, __source: {fileName: _jsxFileName, lineNumber: 153}} )
              , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 100, fontWeight: 300, color: 'rgba(82,58,52,0.06)', lineHeight: 1, marginBottom: -30, userSelect: 'none' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 154}}, "Momo")
              , React.createElement('h2', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(2rem, 3.5vw, 3rem)', fontWeight: 400, color: '#523A34', lineHeight: 1.3, letterSpacing: '0.02em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 155}}, "從敏感肌的困擾"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 156}} )
                , React.createElement('em', { style: { fontStyle: 'italic', color: '#523A34' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 157}}, "到美麗的魔法師")
              )
              , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300, color: '#8B6B5E', lineHeight: 2.2, marginTop: 32, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 159}}, "創辦人 Momo 自國中起即飽受嚴重敏感肌困擾——臉頰長期泛紅、反覆長痘，縱使嘗試各大專業品牌與皮膚科治療，症狀始終未能改善。因從小參與舞蹈表演，對外貌十分在意，肌膚問題帶來的困擾更加深刻。"
              ...
              , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300, color: '#8B6B5E', lineHeight: 2.2, marginTop: 16, letterSpacing: '0.08em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 165}}, "品牌名稱 Magic Garden，源自她對護膚的信念——保養品擁有讓人重拾自信、如花朵般盛放的「魔法」力量。"
              ...
              , React.createElement('div', { className: "stats-row", style: { display: 'flex', gap: 40, marginTop: 48 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 168}}
                , [['17歲', '赴韓研究護膚'], ['30+', '親試護膚配方'], ['18歲', '創立品牌・取得授權']].map(([t, d]) => (
                  React.createElement('div', { key: t, __self: this, __source: {fileName: _jsxFileName, lineNumber: 170}}
                    , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 26, color: '#523A34', fontWeight: 500, letterSpacing: '0.1em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 171}}, t)
                    , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 16, color: '#8B6B5E', marginTop: 6, letterSpacing: '0.06em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 172}}, d)
                  )
                ))
              )
            )
            , React.createElement('div', { className: "reveal-right", style: { position: 'relative' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 177}}
              , React.createElement('div', { style: { position: 'absolute', top: -20, right: -20, width: '100%', height: '100%', border: '1px solid rgba(82,58,52,0.2)', zIndex: 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 178}} )
              , React.createElement('div', { style: { position: 'relative', zIndex: 1, overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 179}}
                ...
                , React.createElement('div', { style: { position: 'absolute', bottom: 0, left: 0, right: 0, background: 'linear-gradient(transparent, rgba(6,13,6,0.88))', padding: '40px 32px 28px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 186}}
                  , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 19, color: '#523A34', letterSpacing: '0.25em', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 187}}, "\"幫助更多人重拾自信，從美麗開始盛放\""
