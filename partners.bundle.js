    ...
    function PartnerInfo() {
      ...
      return (
        React.createElement('section', { className: "sec-dark", style: { padding: '140px 0', position: 'relative', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 162}}
          , React.createElement('div', { style: { position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontFamily: '"Cormorant Garamond", serif', fontSize: 160, fontWeight: 700, color: 'rgba(26,8,40,0.025)', whiteSpace: 'nowrap', userSelect: 'none', pointerEvents: 'none' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 163}}, "PARTNERS"
          ...
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto', padding: '0 48px', position: 'relative' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 166}}
            , React.createElement('div', { style: { textAlign: 'center', marginBottom: 80 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 167}}
              , React.createElement('div', { className: "reveal", style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#1A0828' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 168}}, "PARTNER LOCATIONS" )
              , React.createElement('span', { className: "gold-line", __self: this, __source: {fileName: _jsxFileName, lineNumber: 169}} )
              , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(2rem, 3.5vw, 3.2rem)', fontWeight: 400, color: '#1A0828', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 170}}, "夥伴資訊"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 171}} )
                , React.createElement('em', { style: { color: '#1A0828', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 172}}, "全桃園服務據點")
              )
              , React.createElement('p', { className: "reveal delay-2" , style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: '#3A1E52', lineHeight: 2, marginTop: 20, letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 174}}, "桃園各區皆有專業技師駐點服務 · LINE 預約 · 貴賓優先制"
            ...
            , React.createElement('div', { className: "three-col-grid", style: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 178}}
              , partners.map((p, i) => (
                React.createElement('div', { key: `${p.name}-${i}`, className: `testi-card reveal delay-${(i % 4) + 1}`, style: {
                  ...
                  , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.15em', color: '#1A0828', marginBottom: 14, opacity: 0.8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 193}}, p.shop)
                  , React.createElement('div', { style: { display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 10, gap: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 194}}
                    , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 25, fontWeight: 500, color: '#1A0828', letterSpacing: '0.06em', lineHeight: 1.2 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 195}}, p.name)
                    , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 15, letterSpacing: '0.12em', color: '#1A0828', border: '1px solid rgba(26,8,40,0.35)', padding: '4px 10px', whiteSpace: 'nowrap', flexShrink: 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 196}}, p.area)
                  )
                  ...
                  , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#3A1E52', letterSpacing: '0.07em', marginBottom: 10 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 199}}, p.role)
                  , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#3A1E52', letterSpacing: '0.06em', lineHeight: 1.9, marginBottom: p.feature ? 8 : 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 200}}
                    , React.createElement('span', { style: { color: 'rgba(26,8,40,0.7)', fontSize: 16 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 201}}, "專長｜"), p.specialty
                  )
                  , p.feature && (
                    React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#3A1E52', letterSpacing: '0.06em', lineHeight: 1.9 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 204}}
                      , React.createElement('span', { style: { color: 'rgba(26,8,40,0.7)', fontSize: 16 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 205}}, "特點｜"), p.feature
                    )
                  )
                  , React.createElement('div', { style: { marginTop: 'auto', paddingTop: 20, display: 'flex', alignItems: 'center', gap: 16 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 208}}
                    , p.qr ? (
                      React.createElement('img', { src: p.qr, alt: `${p.name} LINE QR`, style: { width: 72, height: 72, objectFit: 'contain', border: '1px solid rgba(26,8,40,0.25)', padding: 4, background: '#fff' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 210}} )
                    ) : (
                      React.createElement('div', { style: { width: 72, height: 72, border: '1px dashed rgba(26,8,40,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 212}}
                        , React.createElement('span', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 15, color: '#3A1E52', textAlign: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 213}}, "QR 圖檔待補" )
                      )
                    )
                    , p.line && p.line !== '#' ? (
