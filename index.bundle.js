    ...
    function Nav({ isHome = false, currentPage = '' }) {
      ...
      return (
        React.createElement('nav', { style: {
          ...
          background: (scrolled || menuOpen) ? 'rgba(250,249,246,0.97)' : 'transparent',
          backdropFilter: (scrolled || menuOpen) ? 'blur(14px)' : 'none',
          borderBottom: `1px solid ${(scrolled || menuOpen) ? 'rgba(26,8,40,0.18)' : 'transparent'}`,
          ...
          , React.createElement('div', { style: { maxWidth: 1440, margin: '0 auto', padding: '0 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 76 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 44}}
            , React.createElement('a', { href: "index.html", style: { textDecoration: 'none', flexShrink: 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 45}}
              , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 21, fontWeight: 500, letterSpacing: '0.1em', color: '#1A0828', lineHeight: 1 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 46}}, "Magic Garden 美肌花園"  )
              , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 11, letterSpacing: '0.35em', color: '#3A1E52', marginTop: 4 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 47}}, "ENERGY · BEAUTY · VITALITY"    )
            )
            , React.createElement('div', { className: "nav-links", style: { display: 'flex', gap: 20, alignItems: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 49}}
              , links.map(l => (
                React.createElement('a', { key: l.label, href: l.href, className: "nav-link", style: {
                  ...
                  borderBottom: currentPage === l.page ? '1px solid rgba(200,168,88,0.65)' : 'none',
                  paddingBottom: 2,
                },
...
, l.label)
              ...
              , React.createElement('a', { href: "member.html", style: { textDecoration: "none" }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 62}}, React.createElement('button', { style: { padding: "9px 20px", fontSize: 14, fontFamily: '"Noto Serif TC", serif', letterSpacing: '0.05em', color: '#1A0828', background: 'transparent', border: '1px solid rgba(90,50,110,0.48)', borderRadius: 4, cursor: 'pointer', whiteSpace: 'nowrap', transition: 'all 0.3s' }, onMouseEnter: e => { e.currentTarget.style.background='rgba(26,8,40,0.08)'; e.currentTarget.style.borderColor='rgba(90,50,110,0.78)'; }, onMouseLeave: e => { e.currentTarget.style.background='transparent'; e.currentTarget.style.borderColor='rgba(26,8,40,0.5)'; }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 62}}, React.createElement('span', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 62}}, "會員登入")))
            )
    ...
    function Footer() {
      ...
      return (
        React.createElement('footer', { style: { background: '#FAF9F6', borderTop: '1px solid rgba(26,8,40,0.12)', padding: '80px 48px 40px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 109}}
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 110}}
            , React.createElement('div', { style: { display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 60, paddingBottom: 60, borderBottom: '1px solid rgba(26,8,40,0.08)' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 111}}
              , React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 112}}
                , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 26, fontWeight: 500, letterSpacing: '0.15em', color: '#1A0828', marginBottom: 4 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 113}}, "Magic Garden 美肌花園"  )
                , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 13, letterSpacing: '0.45em', color: '#3A1E52', marginBottom: 24 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 114}}, "ENERGY · BEAUTY · VITALITY"    )
                , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#3A1E52', lineHeight: 2.2, letterSpacing: '0.07em', maxWidth: 300 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 115}}, "能量美學品牌 · 開運美容護膚／秀髮養育"  , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 115}} ), "貴賓預約優先制")
                , React.createElement('div', { style: { marginTop: 20 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 116}}
                  , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#3A1E52', letterSpacing: '0.07em', marginBottom: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 117}}, "📞 0927-186-901" )
                  , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#3A1E52', letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 118}}, "✉️ acandy135789@gmail.com" )
                )
              )
              , cols.map(col => (
                React.createElement('div', { key: col.title, __self: this, __source: {fileName: _jsxFileName, lineNumber: 122}}
                  , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.35em', color: '#1A0828', marginBottom: 24 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 123}}, col.title)
...
, l.label)
                          , phoneOpen && (
                            ...
                            , React.createElement('div', { style: { position: 'absolute', left: 0, top: '110%', background: 'rgba(13,26,14,0.97)', border: '1px solid rgba(90,50,110,0.45)', padding: '12px 20px', zIndex: 100, display: 'flex', flexDirection: 'column', gap: 12 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 135}}
                              , React.createElement('a', { href: "tel:0906607856", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#1A0828', textDecoration: 'none', letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 136}}, "0906-607-856")
                              , React.createElement('a', { href: "tel:0927186901", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#1A0828', textDecoration: 'none', letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 137}}, "0927-186-901")
                            )
                            )
                          )
                        )
...
, l.label)
                          , emailOpen && (
                            ...
                            , React.createElement('div', { style: { position: 'absolute', left: 0, top: '110%', background: 'rgba(13,26,14,0.97)', border: '1px solid rgba(90,50,110,0.45)', padding: '12px 20px', zIndex: 100 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 151}}
                              , React.createElement('a', { href: "mailto:acandy135789@gmail.com", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#1A0828', textDecoration: 'none', letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 152}}, "acandy135789@gmail.com")
                            )
                            )
                          )
                        )
...
, l.label)
            ...
            , React.createElement('div', { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: 32, flexWrap: 'wrap', gap: 16 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 168}}
              , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 16, color: 'rgba(106,122,114,0.55)', letterSpacing: '0.1em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 169}}, "© 2025 Magic Garden 美肌花園. All Rights Reserved."       )
            )
          )
        )
      );
        ...
        React.createElement('section', { id: "home", className: "hero-bg", style: { position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'center', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 178}}
          ...
          , [
            ...
            React.createElement('div', { key: i, className: "orb", style: {
              ...
              background: 'radial-gradient(circle, rgba(26,8,40,0.9), rgba(26,8,40,0.08))',
              boxShadow: '0 0 8px rgba(26,8,40,0.6)',
          ...
          , React.createElement('div', { className: "hero-inner", style: { position: 'relative', zIndex: 3, maxWidth: 1380, margin: '0 auto', padding: '0 48px', width: '100%', paddingTop: 120 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 196}}
            ...
            , React.createElement('div', { className: "hero-cta-row", style: { display: 'flex', gap: 20, marginTop: 52, alignItems: 'center', flexWrap: 'wrap', opacity: 0, animation: 'fadeSlide 1.2s ease 1.3s forwards' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 220}}
              ...
              , React.createElement('a', { href: "member.html", style: { textDecoration: 'none' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 222}}, React.createElement('button', { style: { padding: "14px 32px", fontFamily: '"Noto Serif TC", serif', fontSize: 18, fontWeight: 500, letterSpacing: '0.1em', color: '#1A0828', background: 'transparent', border: '1px solid rgba(90,50,110,0.55)', borderRadius: 8, cursor: 'pointer', boxShadow: 'none', transition: 'all 0.3s' }, onMouseEnter: e => { e.currentTarget.style.background='rgba(90,50,110,0.07)'; e.currentTarget.style.borderColor='rgba(90,50,110,0.82)'; e.currentTarget.style.transform='translateY(-1px)'; }, onMouseLeave: e => { e.currentTarget.style.background='transparent'; e.currentTarget.style.borderColor='rgba(90,50,110,0.55)'; e.currentTarget.style.transform='none'; }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 222}}, React.createElement('span', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 222}}, "加入會員")))
              , React.createElement('a', { href: "founder.html", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: '#1A0828', textDecoration: 'none', letterSpacing: '0.1em', borderBottom: '1px solid rgba(90,50,110,0.48)', paddingBottom: 2, transition: 'color 0.3s', textShadow: '0 1px 0 rgba(255,252,255,0.90), 0 0 6px rgba(252,248,255,0.60)' },
...
, "認識創辦人 →" )
            ...
            , React.createElement('div', { className: "hero-stats", style: { display: 'flex', gap: 60, marginTop: 80, paddingTop: 40, borderTop: '1px solid rgba(26,8,40,0.12)', opacity: 0, animation: 'fadeSlide 1.2s ease 1.6s forwards' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 228}}
              , [
                ...
                React.createElement('div', { key: s.label, className: "hero-stat-item", __self: this, __source: {fileName: _jsxFileName, lineNumber: 234}}
                  , React.createElement('div', { className: "hero-stat-num", style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 36, fontWeight: 300, color: '#1A0828', lineHeight: 1 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 235}}, s.num)
                  , React.createElement('div', { className: "hero-stat-label", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 16, color: '#3A1E52', marginTop: 8, letterSpacing: '0.1em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 236}}, s.label)
                )
              ))
            )
          )
          , React.createElement('div', { className: "scroll-indicator", style: { position: 'absolute', bottom: 40, left: '50%', transform: 'translateX(-50%)', zIndex: 3, textAlign: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 241}}
            , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.4em', color: '#3A1E52', marginBottom: 12 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 242}}, "SCROLL")
    ...
    function Marquee() {
      ...
      return (
        React.createElement('div', { style: { background: 'rgba(26,8,40,0.08)', borderTop: '1px solid rgba(26,8,40,0.12)', borderBottom: '1px solid rgba(26,8,40,0.12)', padding: '18px 0', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 266}}
          , React.createElement('div', { className: "marquee-track", __self: this, __source: {fileName: _jsxFileName, lineNumber: 267}}
            , items.map((w, i) => (
              React.createElement('span', { key: i, style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, letterSpacing: '0.2em', color: '#1A0828', padding: '0 40px', whiteSpace: 'nowrap', opacity: 0.85 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 269}}
        ...
        React.createElement('section', { style: { background: 'linear-gradient(150deg, #FFFBF9 0%, #F7D6C8 100%)', padding: '100px 48px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 290}}
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 291}}
            , React.createElement('div', { style: { textAlign: 'center', marginBottom: 64 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 292}}
              , React.createElement('div', { className: "reveal", style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#1A0828' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 293}}, "EXPLORE")
              , React.createElement('span', { className: "gold-line", __self: this, __source: {fileName: _jsxFileName, lineNumber: 294}} )
              , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 400, color: '#1A0828', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 295}}, "探索我們的世界"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 296}} )
                , React.createElement('em', { style: { color: '#1A0828', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 297}}, "Magic Garden 美肌花園"  )
              )
            )
              ...
              , sections.slice(0, 6).map((s, i) => (
                React.createElement('a', { key: s.title, href: s.href, style: { textDecoration: 'none' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 302}}
                  , React.createElement('div', { className: `ing-circle reveal delay-${(i % 3) + 1}`, style: {
                    ...
                    , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.35em', color: '#C8A85C', marginBottom: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 312}}, s.en)
                    , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 26, fontWeight: 500, color: '#1A0828', letterSpacing: '0.05em', marginBottom: 12 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 313}}, s.title)
                    ...
                    , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#3A1E52', lineHeight: 2, letterSpacing: '0.06em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 315}}, s.desc)
                    , React.createElement('div', { style: { marginTop: 20, fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#C8A85C', letterSpacing: '0.1em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 316}}, "了解更多 →" )
                  )
                )
              ))
            )
            , React.createElement('a', { href: sections[6].href, style: { textDecoration: 'none' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 321}}
              , React.createElement('div', { className: "ing-circle overview-last-card reveal"  , style: {
                ...
                , React.createElement('div', { style: { flex: 1 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 332}}
                  , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.4em', color: '#C8A85C', marginBottom: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 333}}, sections[6].en)
                  , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 26, fontWeight: 500, color: '#1A0828', letterSpacing: '0.05em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 334}}, sections[6].title)
                  , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#3A1E52', lineHeight: 2, letterSpacing: '0.06em', marginTop: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 335}}, sections[6].desc)
                )
                , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: '#C8A85C', letterSpacing: '0.15em', flexShrink: 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 337}}, "了解更多 →" )
              )
            )
          )
        )
