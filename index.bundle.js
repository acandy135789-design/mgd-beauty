    ...
    function Nav({ isHome = false, currentPage = '' }) {
      ...
      return (
        React.createElement('nav', { style: {
          ...
          background: (scrolled || menuOpen) ? 'rgba(6,13,6,0.97)' : 'transparent',
          backdropFilter: (scrolled || menuOpen) ? 'blur(14px)' : 'none',
          borderBottom: `1px solid ${(scrolled || menuOpen) ? 'rgba(197,160,89,0.22)' : 'transparent'}`,
          ...
          , React.createElement('div', { style: { maxWidth: 1440, margin: '0 auto', padding: '0 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 76 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 44}}
            , React.createElement('a', { href: "index.html", style: { textDecoration: 'none', flexShrink: 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 45}}
              , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 21, fontWeight: 500, letterSpacing: '0.1em', color: '#C5A059', lineHeight: 1 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 46}}, "Magic Garden 美肌花園"  )
              , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 11, letterSpacing: '0.35em', color: '#9EA89C', marginTop: 4 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 47}}, "ENERGY · BEAUTY · VITALITY"    )
            )
            , React.createElement('div', { className: "nav-links", style: { display: 'flex', gap: 20, alignItems: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 49}}
              , links.map(l => (
                React.createElement('a', { key: l.label, href: l.href, className: "nav-link", style: {
                  ...
                  onMouseLeave: e => e.currentTarget.style.color = currentPage === l.page ? '#C5A059' : '#C8D0C4', __self: this, __source: {fileName: _jsxFileName, lineNumber: 51}}
, l.label)
              ))
              , React.createElement('a', { href: "member.html", style: { textDecoration: "none" }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 62}}, React.createElement('button', { style: { padding: "9px 20px", fontSize: 14, fontFamily: '"Noto Serif TC", serif', letterSpacing: '0.05em', color: '#C5A059', background: 'transparent', border: '1px solid rgba(197,160,89,0.5)', borderRadius: 4, cursor: 'pointer', whiteSpace: 'nowrap', transition: 'all 0.3s' }, onMouseEnter: e => { e.currentTarget.style.background='rgba(197,160,89,0.1)'; e.currentTarget.style.borderColor='#C5A059'; }, onMouseLeave: e => { e.currentTarget.style.background='transparent'; e.currentTarget.style.borderColor='rgba(197,160,89,0.5)'; }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 62}}, React.createElement('span', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 62}}, "會員登入")))
            )
    ...
    function Footer() {
      ...
      return (
        React.createElement('footer', { style: { background: '#060810', borderTop: '1px solid rgba(197,160,89,0.15)', padding: '80px 48px 40px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 109}}
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 110}}
            , React.createElement('div', { style: { display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 60, paddingBottom: 60, borderBottom: '1px solid rgba(197,160,89,0.1)' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 111}}
              , React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 112}}
                , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 26, fontWeight: 500, letterSpacing: '0.15em', color: '#C5A059', marginBottom: 4 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 113}}, "Magic Garden 美肌花園"  )
                , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 13, letterSpacing: '0.45em', color: '#9EA89C', marginBottom: 24 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 114}}, "ENERGY · BEAUTY · VITALITY"    )
                , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#9EA89C', lineHeight: 2.2, letterSpacing: '0.07em', maxWidth: 300 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 115}}, "能量美學品牌 · 開運美容護膚／秀髮養育"  , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 115}} ), "貴賓預約優先制")
                , React.createElement('div', { style: { marginTop: 20 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 116}}
                  , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#C8D0C4', letterSpacing: '0.07em', marginBottom: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 117}}, "📞 0927-186-901" )
                  , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#C8D0C4', letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 118}}, "✉️ acandy135789@gmail.com" )
                )
              )
              , cols.map(col => (
                React.createElement('div', { key: col.title, __self: this, __source: {fileName: _jsxFileName, lineNumber: 122}}
                  , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.35em', color: '#C5A059', marginBottom: 24 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 123}}, col.title)
                      ...
                      l.type === 'phone' ? (
                        React.createElement('div', { key: l.label, style: { position: 'relative' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 127}}
                          , React.createElement('span', { onClick: () => setPhoneOpen(o => !o), style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#9EA89C', letterSpacing: '0.07em', cursor: 'pointer', transition: 'color 0.3s' },
                            onMouseEnter: e => e.currentTarget.style.color = '#C5A059',
                            onMouseLeave: e => e.currentTarget.style.color = '#9EA89C', __self: this, __source: {fileName: _jsxFileName, lineNumber: 128}}
, l.label)
                          , phoneOpen && (
                            ...
                            , React.createElement('div', { style: { position: 'absolute', left: 0, top: '110%', background: 'rgba(13,26,14,0.97)', border: '1px solid rgba(197,160,89,0.3)', padding: '12px 20px', zIndex: 100, display: 'flex', flexDirection: 'column', gap: 12 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 135}}
                              , React.createElement('a', { href: "tel:0906607856", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#C5A059', textDecoration: 'none', letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 136}}, "0906-607-856")
                              , React.createElement('a', { href: "tel:0927186901", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#C5A059', textDecoration: 'none', letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 137}}, "0927-186-901")
                            )
                            )
                          )
                        )
                        ...
                        React.createElement('div', { key: l.label, style: { position: 'relative' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 143}}
                          , React.createElement('span', { onClick: () => setEmailOpen(o => !o), style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#9EA89C', letterSpacing: '0.07em', cursor: 'pointer', transition: 'color 0.3s' },
                            onMouseEnter: e => e.currentTarget.style.color = '#C5A059',
                            onMouseLeave: e => e.currentTarget.style.color = '#9EA89C', __self: this, __source: {fileName: _jsxFileName, lineNumber: 144}}
, l.label)
                          , emailOpen && (
                            ...
                            , React.createElement('div', { style: { position: 'absolute', left: 0, top: '110%', background: 'rgba(13,26,14,0.97)', border: '1px solid rgba(197,160,89,0.3)', padding: '12px 20px', zIndex: 100 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 151}}
                              , React.createElement('a', { href: "mailto:acandy135789@gmail.com", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: '#C5A059', textDecoration: 'none', letterSpacing: '0.07em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 152}}, "acandy135789@gmail.com")
                            )
                            )
                          )
                        )
                        ...
                        React.createElement('a', { key: l.label, href: l.href, style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#9EA89C', textDecoration: 'none', letterSpacing: '0.07em', transition: 'color 0.3s' },
                          onMouseEnter: e => e.currentTarget.style.color = '#C5A059',
                          onMouseLeave: e => e.currentTarget.style.color = '#9EA89C', __self: this, __source: {fileName: _jsxFileName, lineNumber: 158}}
, l.label)
                      )
                    ))
                  )
        ...
        React.createElement('section', { id: "home", className: "hero-bg", style: { position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'center', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 178}}
          ...
          , React.createElement('div', { className: "hero-inner", style: { position: 'relative', zIndex: 3, maxWidth: 1380, margin: '0 auto', padding: '0 48px', width: '100%', paddingTop: 120 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 196}}
            , React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 20, marginBottom: 36, opacity: 0, animation: 'fadeSlide 1.2s ease 0.4s forwards' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 197}}
              ...
              , React.createElement('span', { style: { fontFamily: 'Cinzel, serif', fontSize: 16, letterSpacing: '0.45em', color: '#C5A059' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 199}}, "ENERGY BEAUTY · MAGIC GARDEN"    )
            )
            , React.createElement('h1', { className: "hero-h1", style: {
              ...
              , React.createElement('em', { style: { fontStyle: 'italic', color: '#C5A059' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 209}}, "喚醒你的美麗魔法")
            )
            , React.createElement('p', { style: {
              fontFamily: '"Noto Serif TC", serif', fontSize: 20, fontWeight: 300,
              color: '#9EA89C', lineHeight: 2, marginTop: 28, maxWidth: 500, letterSpacing: '0.08em',
            ...
            , React.createElement('div', { className: "hero-cta-row", style: { display: 'flex', gap: 20, marginTop: 52, alignItems: 'center', flexWrap: 'wrap', opacity: 0, animation: 'fadeSlide 1.2s ease 1.3s forwards' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 220}}
              ...
              , React.createElement('a', { href: "member.html", style: { textDecoration: 'none' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 222}}, React.createElement('button', { style: { padding: "14px 32px", fontFamily: '"Noto Serif TC", serif', fontSize: 18, letterSpacing: '0.1em', color: '#C5A059', background: 'transparent', border: '1px solid rgba(197,160,89,0.6)', borderRadius: 4, cursor: 'pointer', transition: 'all 0.3s' }, onMouseEnter: e => e.currentTarget.style.background='rgba(197,160,89,0.1)', onMouseLeave: e => e.currentTarget.style.background='transparent', __self: this, __source: {fileName: _jsxFileName, lineNumber: 222}}, React.createElement('span', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 222}}, "加入會員")))
              , React.createElement('a', { href: "founder.html", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: '#9EA89C', textDecoration: 'none', letterSpacing: '0.1em', borderBottom: '1px solid rgba(158,168,156,0.4)', paddingBottom: 2, transition: 'color 0.3s' },
                onMouseEnter: e => e.currentTarget.style.color = '#C5A059',
                onMouseLeave: e => e.currentTarget.style.color = '#9EA89C', __self: this, __source: {fileName: _jsxFileName, lineNumber: 223}}
, "認識創辦人 →" )
            )
            , React.createElement('div', { className: "hero-stats", style: { display: 'flex', gap: 60, marginTop: 80, paddingTop: 40, borderTop: '1px solid rgba(197,160,89,0.15)', opacity: 0, animation: 'fadeSlide 1.2s ease 1.6s forwards' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 228}}
              , [
                { num: '9+',  label: '全台服務據點' },
                { num: '5+',  label: '專業美療項目' },
                ...
                React.createElement('div', { key: s.label, className: "hero-stat-item", __self: this, __source: {fileName: _jsxFileName, lineNumber: 234}}
                  , React.createElement('div', { className: "hero-stat-num", style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 36, fontWeight: 300, color: '#C5A059', lineHeight: 1 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 235}}, s.num)
                  , React.createElement('div', { className: "hero-stat-label", style: { fontFamily: '"Noto Serif TC", serif', fontSize: 16, color: '#9EA89C', marginTop: 8, letterSpacing: '0.1em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 236}}, s.label)
                )
              ))
            )
          )
          , React.createElement('div', { className: "scroll-indicator", style: { position: 'absolute', bottom: 40, left: '50%', transform: 'translateX(-50%)', zIndex: 3, textAlign: 'center' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 241}}
            , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.4em', color: '#9EA89C', marginBottom: 12 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 242}}, "SCROLL")
    ...
    function Marquee() {
      ...
      return (
        React.createElement('div', { style: { background: 'rgba(197,160,89,0.08)', borderTop: '1px solid rgba(197,160,89,0.15)', borderBottom: '1px solid rgba(197,160,89,0.15)', padding: '18px 0', overflow: 'hidden' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 266}}
          , React.createElement('div', { className: "marquee-track", __self: this, __source: {fileName: _jsxFileName, lineNumber: 267}}
            , items.map((w, i) => (
              React.createElement('span', { key: i, style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, letterSpacing: '0.2em', color: '#C5A059', padding: '0 40px', whiteSpace: 'nowrap', opacity: 0.85 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 269}}
    ...
    function SectionOverview() {
      ...
      return (
        React.createElement('section', { style: { background: 'linear-gradient(150deg, #080c18 0%, #0c1e12 100%)', padding: '100px 48px' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 290}}
          , React.createElement('div', { style: { maxWidth: 1380, margin: '0 auto' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 291}}
            , React.createElement('div', { style: { textAlign: 'center', marginBottom: 64 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 292}}
              , React.createElement('div', { className: "reveal", style: { fontFamily: 'Cinzel, serif', fontSize: 15, letterSpacing: '0.55em', color: '#C5A059' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 293}}, "EXPLORE")
              , React.createElement('span', { className: "gold-line", __self: this, __source: {fileName: _jsxFileName, lineNumber: 294}} )
              , React.createElement('h2', { className: "reveal delay-1" , style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 400, color: '#F0ECE4', lineHeight: 1.3 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 295}}, "探索我們的世界"
                , React.createElement('br', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 296}} )
                , React.createElement('em', { style: { color: '#C5A059', fontStyle: 'italic' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 297}}, "Magic Garden 美肌花園"  )
              )
            )
              ...
              , sections.slice(0, 6).map((s, i) => (
                React.createElement('a', { key: s.title, href: s.href, style: { textDecoration: 'none' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 302}}
                  , React.createElement('div', { className: `ing-circle reveal delay-${(i % 3) + 1}`, style: {
                    background: 'rgba(13,26,14,0.7)', padding: '36px 32px',
                    backdropFilter: 'blur(8px)', height: '100%',
                    transition: 'border-color 0.3s, background 0.3s',
                  },
                    onMouseEnter: e => e.currentTarget.style.background = 'rgba(13,26,14,0.95)',
                    onMouseLeave: e => e.currentTarget.style.background = 'rgba(13,26,14,0.7)', __self: this, __source: {fileName: _jsxFileName, lineNumber: 303}}
                    ...
                    , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.35em', color: '#9EA89C', marginBottom: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 312}}, s.en)
                    , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 26, fontWeight: 500, color: '#F0ECE4', letterSpacing: '0.05em', marginBottom: 12 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 313}}, s.title)
                    , React.createElement('div', { style: { width: 36, height: 1, background: 'linear-gradient(90deg, #C5A059, transparent)', marginBottom: 16 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 314}} )
                    , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#9EA89C', lineHeight: 2, letterSpacing: '0.06em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 315}}, s.desc)
                    , React.createElement('div', { style: { marginTop: 20, fontFamily: '"Noto Serif TC", serif', fontSize: 17, color: 'rgba(197,160,89,0.7)', letterSpacing: '0.1em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 316}}, "了解更多 →" )
                  )
                )
              ))
            )
            , React.createElement('a', { href: sections[6].href, style: { textDecoration: 'none' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 321}}
              , React.createElement('div', { className: "ing-circle overview-last-card reveal"  , style: {
                background: 'rgba(13,26,14,0.7)', padding: '36px 48px',
                backdropFilter: 'blur(8px)',
                display: 'flex', alignItems: 'center', gap: 40,
                transition: 'background 0.3s',
              },
                onMouseEnter: e => e.currentTarget.style.background = 'rgba(13,26,14,0.95)',
                onMouseLeave: e => e.currentTarget.style.background = 'rgba(13,26,14,0.7)', __self: this, __source: {fileName: _jsxFileName, lineNumber: 322}}
                ...
                , React.createElement('div', { style: { flex: 1 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 332}}
                  , React.createElement('div', { style: { fontFamily: 'Cinzel, serif', fontSize: 14, letterSpacing: '0.4em', color: '#9EA89C', marginBottom: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 333}}, sections[6].en)
                  , React.createElement('div', { style: { fontFamily: '"Cormorant Garamond", serif', fontSize: 26, fontWeight: 500, color: '#F0ECE4', letterSpacing: '0.05em' }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 334}}, sections[6].title)
                  , React.createElement('p', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 18, color: '#9EA89C', lineHeight: 2, letterSpacing: '0.06em', marginTop: 8 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 335}}, sections[6].desc)
                )
                , React.createElement('div', { style: { fontFamily: '"Noto Serif TC", serif', fontSize: 19, color: 'rgba(197,160,89,0.7)', letterSpacing: '0.15em', flexShrink: 0 }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 337}}, "了解更多 →" )
              )
            )
          )
        )
